...
def draw_styled_username_part18(name: str, color: str, tag: str, rozet: str, is_admin: bool = False) -> rx.Component:
    tag_badge = rx.cond(
        tag != "",
        rx.badge(tag, variant="solid", size="xs", color_scheme=rx.cond(tag == "KURUCU", "orange", "purple"), margin_right="4px"),
        rx.spacer()
    )
...
def draw_styled_username_part19(name: str, color: str, tag: str, rozet: str, is_glow: bool = False) -> rx.Component:
    tag_badge = rx.cond(
        tag != "",
        rx.badge(tag, variant="solid", size="xs", color_scheme=rx.cond(tag == "KURUCU", "orange", rx.cond(tag == "YÖNETİCİ", "purple", "teal")), margin_right="4px"),
        rx.spacer()
    )
